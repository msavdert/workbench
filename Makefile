...
lint: ## shellcheck + shfmt check
	shellcheck -e SC1091 providers/proxmox/create-vm.sh box/bootstrap.sh box/files/opwith box/files/agent-session box/files/remote-add box/files/remote-rm box/files/remote-ls
	shfmt -d -i 2 -ci providers/proxmox/create-vm.sh box/bootstrap.sh
